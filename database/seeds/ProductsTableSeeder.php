...
class ProductsTableSeeder extends Seeder {
	...
	public function run() {
		...
		Product::create([
			...
			'typeId' => 2, 
			'attachedImage' => '/img/full-size/signature-paralyzer-attached.jpg',
			'detachedImage' => '/img/full-size/signature-paralyzer-detached.jpg',
			'thumb' => '/img/thumbs/signature-paralyzer.png',
			'emailImage' => '/img/email-assets/thumbs/signature-e.png',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 2, 
			'attachedImage' => '/img/full-size/barbed-paralyzer-attached.jpg',
			'detachedImage' => '/img/full-size/barbed-paralyzer-detached.jpg',
			'thumb' => '/img/thumbs/barbed-paralyzer.png',
			'emailImage' => '/img/email-assets/thumbs/barbed-e.png',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 2, 
			'attachedImage' => '/img/full-size/sliptip-attached.jpg',
			'detachedImage' => '/img/full-size/sliptip-detached.jpg',
			'thumb' => '/img/thumbs/slip-tip.png',
			'emailImage' => '/img/email-assets/thumbs/sliptip-e.png',
			'name' => 'SlipTip',
			'shortName' => 'SlipTip',
			'slug' => 'slip-tip',
			'price' => 6500,
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 2, 
			'attachedImage' => '/img/full-size/flopper-attached.jpg',
			'detachedImage' => '/img/full-size/flopper-detached.jpg',
			'thumb' => '/img/thumbs/flopper.png',
			'emailImage' => '/img/email-assets/thumbs/flopper-e.png',
			'name' => 'Flopper',
			'shortName' => 'Flopper',
			'slug' => 'flopper',
			'price' => 5500,
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 1, 
			'attachedImage' => '/img/full-size/sixer-attached.jpg',
			'detachedImage' => '/img/full-size/sixer-detached.jpg',
			'thumb' => '/img/thumbs/polespear-end.png',
			'emailImage' => '/img/email-assets/thumbs/polespear-e.png',
			'name' => 'Six\'er',
			'shortName' => 'Six',
			'slug' => 'sixer',
			'price' => 12000,
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 1, 
			'attachedImage' => '/img/full-size/sevener-attached.jpg',
			'detachedImage' => '/img/full-size/sevener-detached.jpg',
			'thumb' => '/img/thumbs/polespear-end.png',
			'emailImage' => '/img/email-assets/thumbs/polespear-e.png',
			'name' => 'Seven\'er',
			'shortName' => 'Seven',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 1, 
			'attachedImage' => '/img/full-size/eighter-attached.jpg',
			'detachedImage' => '/img/full-size/eighter-detached.jpg',
			'thumb' => '/img/thumbs/polespear-end.png',
			'emailImage' => '/img/email-assets/thumbs/polespear-e.png',
			'name' => 'Eight\'er',
			'shortName' => 'Eight',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 1, 
			'attachedImage' => '/img/full-size/niner-attached.jpg',
			'detachedImage' => '/img/full-size/niner-detached.jpg',
			'thumb' => '/img/thumbs/polespear-end.png',
			'emailImage' => '/img/email-assets/thumbs/polespear-e.png',
			'name' => 'Nine\'er',
			'shortName' => 'Nine',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 1, 
			'attachedImage' => '/img/full-size/tener-attached.jpg',
			'detachedImage' => '/img/full-size/tener-detached.jpg',
			'thumb' => '/img/thumbs/polespear-end.png',
			'emailImage' => '/img/email-assets/thumbs/polespear-e.png',
			'name' => 'Ten\'er',
			'shortName' => 'Ten',
		...
		Product::create([
			...
			'typeId' => 3, 
			'attachedImage' => '',
			'detachedImage' => '/img/full-size/inshore-shrinker-detached-2.jpg',
			'thumb' => '/img/thumbs/inshore-shrinker.png',
			'emailImage' => '/img/email-assets/thumbs/shrinker-e.png',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 4, 
			'attachedImage' => '/img/full-size/knife-attached.jpg',
			'detachedImage' => '',
			'thumb' => '/img/thumbs/knife.png',
			'emailImage' => '/img/email-assets/thumbs/knife-e.png',
			'name' => 'Budk',
			'shortName' => 'Budk',
			'slug' => 'budk',
			'price' => 1700,
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 4, 
			'attachedImage' => '/img/full-size/hardcore-band-attached.jpg',
			'detachedImage' => '',
			'thumb' => '/img/thumbs/band.png',
			'emailImage' => '/img/email-assets/thumbs/band-e.png',
			'name' => 'Extra Band',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 5, 
			'attachedImage' => '/img/apparel/niner/niner-1.jpg',
			'detachedImage' => '',
			'thumb' => '/img/thumbs/niner-tshirt-thumb.jpg',
			'emailImage' => '/img/email-assets/thumbs/niner-e.jpg',
			'name' => '9\'ER',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 5, 
			'attachedImage' => '/img/apparel/superhero/superhero-1.jpg',
			'detachedImage' => '',
			'thumb' => '/img/thumbs/superhero-tshirt-thumb.jpg',
			'emailImage' => '/img/email-assets/thumbs/superhero-e.jpg',
			'name' => 'SuperHero',
		...
		Product::create([
			'availabilityTypeId' => 1,
			'typeId' => 5, 
			'attachedImage' => '/img/apparel/comfort/comfort-1.jpg',
			'detachedImage' => '',
			'thumb' => '/img/thumbs/comfort-jacket-thumb.jpg',
			'emailImage' => '/img/email-assets/thumbs/comfort-e.jpg',
			'name' => 'Comfort',
