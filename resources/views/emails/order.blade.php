...
<center>
    <table id="body-table" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%"
           style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica, Arial, sans-serif;margin: 0;padding: 0;height: 100%;width: 100%;">
        <tr>
            <td id="body-cell" align="center" valign="top"
                style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica, Arial, sans-serif;margin: 0;padding: 0;height: 100%;width: 100%;padding-bottom:50px">
                <table id="container" border="0" cellpadding="0" cellspacing="0" width="1000px"
                       style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Helvetica', Arial, sans-serif;max-width: 800px;">
                    <thead>
                    <tr>
                        <th id="header" align="left" valign="top" colspan="2" style="height: 45px;font-family: "
                            Helvetica
                        ", Arial, sans-serif;">
                        <!-- Logo image here -->
                        <img src="{{ asset($homeSetting['order_email_logo_url']) }}" height="40px"
                    ...
                    <tr>
                        <th id="order-info" colspan="2" padding="0" align="left"
                            style="width: 100%;height: 35px;border-bottom: 1px solid black;font-family: 'Helvetica', Arial, sans-serif;padding: 0 0 0 0px;color:#E24A62">
                    ...
                    <tbody>
                    <tr id="main"
                        style="max-width: 950px;width: 90%;font-family: 'Helvetica', Arial, sans-serif;padding-top: 10px;">
                        <td id="main-data-1" valign="top"
                            style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Helvetica', Arial, sans-serif;width: 30%;padding-top: 20px;padding-bottom: 20px;font-size: 16px;font-weight: 200;">
                        ...
                        <td id="main-data-2" align="right"
                            style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Helvetica', Arial, sans-serif;width: 70%;">
                            ...
                            <div style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica, Arial, sans-serif;">
                                ...
                                @foreach($order['items'] as $i => $item)
                                    <div class="product"
                                         style="{{ $i == 0 ? 'padding-top:20px;' : 'padding-top:30px; border-top:1px solid black; ' }}padding-bottom:0px;border-bottom:1px solid black;height:290px; overflow:hidden;">
                                                        ...
                                                        <tr class="product-name-row">
                                                            ...
                                                            @if($item['product']['sizeable'])
                                                                <td><span class="product-name"
                                                                          style="text-transform:uppercase;"><strong>{{ $item['size']['name'] }}</strong></span>
                                                                </td>
                                                            @else
                                                            ...
                                                            <td>
                                                                <span class="product-quantity @if($item['quantity'] > 1) multiple @endif">{{ $item['quantity'] }}</span>
                                                            </td>

                                                            @if($item['product']['sizeable'])
                                                                <td>
                                                                    <span class="product-final-price">${{ ($item['size']['price'] * $item['quantity']) / 100}}</span>
                                                                </td>
                                                            @else
                                                                <td>
                                                                    <span class="product-final-price">${{ ($item['product']['price'] * $item['quantity']) / 100}}</span>
                                                                </td>
                                                            @endif
                                                    ...
                                                    @foreach($item['addons'] as $ii => $addon)
                                                        <!-- first addon -->
                                                            <tr class="main-product {{ $ii == 0 ? 'first-opt-set' : '' }}">
                                                                ...
                                                                <td>
                                                                    <span class="product-quantity @if($addon['quantity'] > 1) multiple @endif">{{ $addon['quantity'] }}</span>
                                                                </td>
                            ...
                            <p id="total"
                               style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica, Arial, sans-serif;border-top: 1px solid black;padding-top: 10px;font-weight: bold;">
                                @if($discount['discount'] > 0)
                                    <span style="font-weight:normal">Discount: <span
                                                style="color:#2ECC71;">- ${{ $discount['discount'] / 100 }}</span></span>
                                    <br>
                                @endif
                    ...
                    <tr id="totals"
                        style="font-family: 'Helvetica', Arial, sans-serif;font-size: 12px;color: #D1D1D1;border-top: 1px solid black;height: 50px;">
                        <td colspan="2" align="right"
                            style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica, Arial, sans-serif; color:#E24A62;">
                        ...
                        <td colspan="2">
                            <table style="width:inherit;" style="margin-bottom:30px;">
                                ...
                                <tr id="thefooter" style="border-top:solid black 1px; border-bottom:solid black 1px;">
                                    <td style="color:#E24A62;font-size:16px; padding:15px 0;" colspan="1">Customer
